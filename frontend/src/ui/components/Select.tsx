      ...
      <div className="relative">
        <label
          className={cn(
            ...
            selectedValue && 'text-xs transition-all left-[13px] top-2 translate-y-0',
          )}
          >
          {placeholder}
        </label>
        ...
        <RdxSelect.Root value={value} onValueChange={handleSelect}>
          <RdxSelect.Trigger
              className={cn(
                'bg-white w-full rounded-lg border border-gray-500 px-3 h-[52px] text-gray-800 focus:border-gray-800 transition-all',
              ...
              <RdxSelect.Viewport className="p-2">
                {options.map((option) => (
                  <RdxSelect.Item
                      ...
                      value={option.value}
                      className={cn(
                        "p-2 text-gray-800 text-sm data-[state=checked]:font-bold data-[highlighted]:bg-gray-50 rounded-lg transition-colors",
                      )}
                    >
